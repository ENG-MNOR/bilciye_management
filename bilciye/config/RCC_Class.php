						...
						while($row=$this->result->fetch_array(MYSQLI_NUM)){ ?>
							<tr>
								...
								<td class="td-actions text-center">
									...
									<button type="button" title='Edit' class="btn btn-primary btn-xs <?php echo "btn_edit_".str_replace('dt_', '', $dtTble); ?>" value="<?php echo $row[0];?>"><i class="fa fa-pencil"></i></button>

									<button type="button" title='View' class="btn btn-success btn-xs" id="btn_view_img" data-toggle="modal" data-target="#img_display"><i class="fa fa-eye "></i></button>
