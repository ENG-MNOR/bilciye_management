...
select cit_id ID, name Name, tell Tell, image Image, citizen.password Password, email Email, home_number 'Home No', concat(address.district,', ',address.village,', ',address.zone) Address from citizen,address where citizen.add_no=address.add_no and citizen.deleted=0;
end$$
...
(9, 'moha', '9090', '123', 'admin@gmail.com', '9090', 3, '', 0),
...
(1, 'rikaab', '843898438', 4, 1, 0),
(2, 'deegandhowr', '12345', 2, 1, 0);
...
(6, 2, 'Plastic', 9, 100, 0.01, '2024-04-17', 1, 0),
(7, 2, 'plastic', 7, 20, 0.06, '2024-04-05', 1, 0);
...
(3, 'Saciid', '1234', 'Gov', 'Gov2024.so', 0);
...
(35, 7, 1, 1, '2024-04-03 21:00:00', '2024-04-10 00:00:00', 0);
...
--
ALTER TABLE `address`
  MODIFY `add_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `recycling`
  MODIFY `recy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
